...
import { OnchainArciumStruct } from "../target/types/onchain_arcium_struct";
...
describe("OnchainArciumStruct", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .OnchainArciumStruct as Program<OnchainArciumStruct>;
  ...
  async function initAddTogetherCompDef(
    program: Program<OnchainArciumStruct>,
